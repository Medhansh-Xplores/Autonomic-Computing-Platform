...
router.post("/azure-vpc", authMiddleware, infraController.createAzureVPC);
router.post("/azure-container-apps", authMiddleware, infraController.createAzureContainerApps);
router.post("/azure-db",  authMiddleware, infraController.deployAzureDB);
router.post("/azure-aks", authMiddleware, infraController.createAzureAKS);
